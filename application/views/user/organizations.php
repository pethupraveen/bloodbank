                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <table class="table table-condensed">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Members</th>
                                        <td><span class="label label-info"><?php echo $user->members; ?></span></td>
                                    </tr>
                                    <tr>
                                        <th>Email</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($user->status == 1) { ?>
                                                <a class="text-danger" data-toggle="tooltip" title="Block" href="<?php echo site_url('user/user_change_status/'.($user->id).'/2/1'); ?>"><i class="fa fa-ban"></i></a>
                                            <?php } else { ?>
                                                <a class="text-success" data-toggle="tooltip" title="Activate" href="<?php echo site_url('user/user_change_status/'.($user->id).'/1/1'); ?>"><i class="fa fa-check-circle"></i></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <?php 
