...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/png" href="<?php echo base_url('website/img/favicon.png'); ?>"/>
  ...
  <!-- Revolution css -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('website/vendor/rs-plugin/css/settings.css'); ?>" media="screen"/>
  <link rel="stylesheet" href="<?php echo base_url('website/vendor/rs-plugin/css/extralayer.css'); ?>">
  
  <!-- Flat icon css -->
  <link rel="stylesheet" href="<?php echo base_url('website/vendor/flat-icon/flaticon.css'); ?>">
  
  <!-- Font awesome -->
  <link rel="stylesheet" href="<?php echo base_url('website/vendor/font-awesome/css/font-awesome.min.css'); ?>">
  
  <!-- Owl Carosel css -->
  <link rel="stylesheet" href="<?php echo base_url('website/vendor/owl/css/owl.carousel.css'); ?>">
  <link rel="stylesheet" href="<?php echo base_url('website/vendor/owl/css/owl.theme.default.css'); ?>">
  <link rel="stylesheet" href="<?php echo base_url('website/vendor/owl/css/owl.theme.css'); ?>">
  
  <!-- mmenu -->
  <link type="text/css" rel="stylesheet" href="<?php echo base_url('website/vendor/mmenu/css/jquery.mmenu.css'); ?>" />
  
  <!-- Bootstrap css -->
  <link rel="stylesheet" href="<?php echo base_url('website/vendor/bootstrap/css/bootstrap.css'); ?>">

  <!-- Animate css -->
  <link rel="stylesheet" href="<?php echo base_url('website/css/animate.css'); ?>">

  <!-- Custom Style css -->
  <link rel="stylesheet" href="<?php echo base_url('website/css/hover.css'); ?>">
  <link rel="stylesheet" href="<?php echo base_url('website/css/style.css'); ?>">
  <link rel="stylesheet" href="<?php echo base_url('website/css/responsive.css'); ?>">
...
<body>
  ...
  <div class="main" id="home">
    <!-- slider -->
      ...
      <div class="tp-banner">
        <ul>  <!-- SLIDE  -->
          <li data-transition="fade" data-slotamount="25" data-masterspeed="2500"  data-thumb="<?php echo base_url('website/img/slider/slider_img_01.jpg'); ?>"  data-saveperformance="off">
            <!-- MAIN IMAGE -->
            <img src="<?php echo base_url('website/img/slider/slider_img_01.jpg'); ?>"  alt="fullslide2" data-bgposition="center center" data-kenburns="on" data-duration="12000" data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center center">
    ...
    style="z-index: 9"><img src="<?php echo base_url('website/img/slider/mobile.png'); ?>" alt="" data-ww="550" data-hh="490">
  </div>
  ...
  data-endeasing="Power4.easeIn"
  data-captionhidden="on"
  style="z-index: 9"><img src="<?php echo base_url('website/img/slider/html.png'); ?>" alt="" data-ww="125" data-hh="160">
</div>
...
data-endeasing="Power4.easeIn"
data-captionhidden="on"
style="z-index: 9"><img src="<?php echo base_url('website/img/slider/css.png'); ?>" alt="" data-ww="125" data-hh="160">
</div>
...
data-endeasing="Power4.easeIn"
data-captionhidden="on"
style="z-index: 9"><img src="<?php echo base_url('website/img/slider/js.png'); ?>" alt="" data-ww="125" data-hh="160">
</div>
...
<li class="items" data-transition="slideleft" data-slotamount="1" data-masterspeed="1500" data-thumb="<?php echo base_url('website/img/slider/slider_img_02.jpg'); ?>" data-delay="13000"  data-saveperformance="on">
  <!-- MAIN IMAGE -->
  <img src="<?php echo base_url('website/img/slider/slider_img_02.jpg'); ?>"  alt="kenburns1"  data-bgposition="left center" data-kenburns="on" data-duration="14000" data-ease="Linear.easeNone" data-bgfit="100" data-bgfitend="130" data-bgpositionend="right center">
  <!-- LAYERS -->
...
<li class="items" data-transition="slidevertical" data-slotamount="1" data-masterspeed="1500" data-thumb="<?php echo base_url('website/img/slider/slider_img_03.jpg'); ?>" data-delay="13000"  data-saveperformance="off">
  <!-- MAIN IMAGE -->
  <img src="<?php echo base_url('website/img/slider/slider_img_03.jpg'); ?>"  alt="kenburns1"  data-bgposition="left center" data-kenburns="on" data-duration="14000" data-ease="Linear.easeNone" data-bgfit="100" data-bgfitend="130" data-bgpositionend="right center">
  <!-- LAYERS -->
...
<i class="scroll-bottom"><img  src="<?php echo base_url('website/img/slider_button.png'); ?>"  alt="arrow-down.png" class="img-responsive" ></i>
</div>
</li>
</ul>
</div>
    ...
    <div class="navi navbar-default" role="navigation">
      <div class="container">
        <div class="navbar-header page-scroll">
          ...
          <a class="navbar-brand" href="index.html"><img src="<?php echo base_url('website/img/logo.png'); ?>" alt="TechGut"></a>
        </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-xs-6 col-sm-2 col-md-2 hidden-xs">
        <div class="image-box">
          <img class="img-responsive" src="<?php echo base_url('website/img/phn.png'); ?>" alt="">
        </div>
      </div><!-- /col-md-2 -->
...
<section  class="counting section-padding">
  <div class="container">
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-6 col-md-3 text-center">
        <span class="count2 counter">1031</span>
        <p>Blood Donated</p>
      </div><!-- /.col-sm-3 -->
      <div class="col-xs-12 col-sm-6 col-md-3 text-center">
      ...
      <div class="container">
        <div class="row">
          <div class="wow zoomIn col-xs-12 col-sm-6 col-md-4">
            ...
            <p class="footer-content">Save Life, Donate Blood.</p>
          </div><!-- /.col-xs-12 .col-sm-3 .col-md-3 -->
          <div class="wow zoomIn col-xs-12 col-sm-3 col-md-4">
          ...
          <div class="wow zoomIn col-xs-12 col-sm-6 col-md-4">
            ...
            <ul class="footercontact">
              <li><i class="flaticon-mainpage"></i><span>address:</span> ODBMS, 54100</li>
              <li><i class="flaticon-phone16"></i><span>phone:</span><a href="#"> +91 9998887770</a></li>
              <li><i class="flaticon-email21"></i><span>e-mail:</span><a href="#"> info@odbms.com</a></li>
              <li><i class="flaticon-world91"></i><span>web:</span><a href="#"> www.odbms.com</a></li>
            </ul>
...
<!-- jQuery JS -->
<script src="<?php echo base_url('website/js/jquery-1.11.1.js'); ?>"></script>

<!-- Modernizr JS --> 
<script src="<?php echo base_url('website/js/modernizr-2.6.2.min.js'); ?>"></script>

<!--Bootatrap JS-->
<script src="<?php echo base_url('website/vendor/bootstrap/js/bootstrap.min.js'); ?>"></script>

<!-- REVOLUTION Slider  -->
<script type="text/javascript" src="<?php echo base_url('website/vendor/rs-plugin/js/jquery.themepunch.plugins.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('website/vendor/rs-plugin/js/jquery.themepunch.revolution.js'); ?>"></script>

<!-- Shuffle JS -->
<script src="<?php echo base_url('website/js/jquery.shuffle.min.js'); ?>"></script>

<!-- mmenu -->
<script type="text/javascript" src="<?php echo base_url('website/vendor/mmenu/js/jquery.mmenu.min.js'); ?>"></script>

<!-- Owl Carosel -->
<script src="<?php echo base_url('website/vendor/owl/js/owl.carousel.min.js'); ?>"></script>
...
<!-- Easing JS -->
<script src="<?php echo base_url('website/js/jquery.easing.min.js'); ?>"></script>

<!-- Smooth Scroll JS -->
<script src="<?php echo base_url('website/js/scrolling-nav.js'); ?>"></script>
<script src="<?php echo base_url('website/js/smoothscroll.min.js'); ?>"></script>

<!-- Custom Script JS -->
<script src="<?php echo base_url('website/js/script.js'); ?>"></script>

<!-- Email JS -->
<script src="<?php echo base_url('website/js/email.js'); ?>"></script>
